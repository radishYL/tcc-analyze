package com.tcc.psringboot.config;
...
@MapperScan(value = {"com.yl.commons.mapper"})
...
public class MyBatisConfig {
    ...
    public DataSource druidDataSource(
        @Value("${biz.jdbc.driverClassName}")String driverClass,
        @Value("${biz.jdbc.url}")String url,
        @Value("${biz.jdbc.user}")String user,
        @Value("${biz.jdbc.password}")String password
    ){
